...
else if ($_SERVER['SERVER_ADDR'] == '112.124.19.200') {
    define('MYSQL_SERVER', 'rdsji2uquji2uqu.mysql.rds.aliyuncs.com');
	define('MYSQL_USER', 'dev');
	define('MYSQL_PASSWORD', 'protimedev');
	define('MYSQL_DATABASE', 'el_lady');
}
else {
	define('MYSQL_SERVER', '172.31.28.21');
	define('MYSQL_USER', 'protime');
	define('MYSQL_PASSWORD', '07ckA5XW');
	define('MYSQL_DATABASE', 'el_lady_V4');
}
